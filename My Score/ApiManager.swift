...
class ApiManager {
    ...
    static func loadParticipants(league: LeagueModel, completion: @escaping ([TeamModel]) -> Void) {
        ...
        let request = NSMutableURLRequest(url: NSURL(string: "https://api-football-v1.p.rapidapi.com/v3/teams?league=\(league.id)&season=\(league.season)")! as URL,
